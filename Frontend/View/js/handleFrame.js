class HandleFrame {
    static loadDetailFrame(folderId, videoId, frameId, score) {
        ...
        let scoreContainer = document.getElementById("single-frame-score")
    ...
    static loadFrame(imgPath, scores) {
        let multipleResultContainer = document.getElementById("multiple-results")
        ...
        imgPath.forEach((path, idx) => {
            ...
            frameContainer.addEventListener("click", e => {
                this.loadDetailFrame(folderId, videoId, frameId, scores[idx])
            })
